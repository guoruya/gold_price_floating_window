...
- `中行`：基准数据源
- `工行`：按基准数据源人民币价格 `+4`，美元价格与基准数据源一致
- `建行`：按基准数据源人民币价格 `+4`，美元价格与基准数据源一致
- `农行`：按基准数据源人民币价格 `+4`，美元价格与基准数据源一致
- `兴业`：按基准数据源人民币价格 `+5`，美元价格与基准数据源一致
- `招商`：按基准数据源人民币价格 `+6`，美元价格与基准数据源一致
- `京东民生`：按基准数据源人民币价格 `+4`，美元价格与基准数据源一致
